...
public class PanelController {
  ...
  @GetMapping(path = "/api/panels/{panel-String}")
  public ResponseEntity<?> getPanelsByPanelString(
  ...
  public ResponseEntity<?> saveHourlyElectricity(
    ...
    System.out.println(hourlyElectricity);
  ...
  public ResponseEntity<List<DailyElectricity>> getElectricityStatisticsForPanel(
      @PathVariable(value = "panel-serial") String panelSerial) {
    Panel panel = panelService.findBySerial(panelSerial);
    if(panel!=null) {
      List<DailyElectricity> dailyElectricityForPanel = hourlyElectricityService.getDailystatistics(panel.getId());
